...
Write-Host
Write-Host -BackgroundColor Green -ForegroundColor Black "Connecting new site database..."
Write-Host
...
Write-Host
Write-Host -BackgroundColor Green -ForegroundColor Black "Cconnecting new Logging and Monitoring databases..."
Write-Host
