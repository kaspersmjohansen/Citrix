...
.EXAMPLES
    Export published applications:
        ...
        Migrate-XAapps -DesktopGroupName "XenApp" -Export

    Export published applications with custom CSV output path:

        Migrate-XAapps -DesktopGroupName "XenApp" -CSVOutput C:\CSVOutput -Export

    Import published applications:

        Migrate-XAapps -DesktopGroupName "XenApp" -Import

    Import published applications with custom CSV input path:

        Migrate-XAapps -DesktopGroupName "XenApp" -CSVInput C:\CSVInput -Import
